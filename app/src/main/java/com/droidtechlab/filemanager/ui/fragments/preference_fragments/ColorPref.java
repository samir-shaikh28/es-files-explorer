...
package com.droidtechlab.filemanager.ui.fragments.preference_fragments;

import com.afollestad.materialdialogs.MaterialDialog;
import com.afollestad.materialdialogs.Theme;
import com.droidtechlab.filemanager.R;
import com.droidtechlab.filemanager.adapters.ColorAdapter;
import com.droidtechlab.filemanager.ui.activities.PreferencesActivity;
import com.droidtechlab.filemanager.ui.colors.ColorPreference;
import com.droidtechlab.filemanager.ui.colors.UserColorPreferences;
import com.droidtechlab.filemanager.ui.dialogs.ColorPickerDialog;
import com.droidtechlab.filemanager.ui.views.preference.InvalidablePreferenceCategory;
 ...
 *
 * <p>Created by Arpit on 21-06-2015 edited by Emmanuel Messulam <emmanuelbendavid@gmail.com>
 */
public class ColorPref extends PreferenceFragment implements Preference.OnPreferenceClickListener {
  ...
  private static final String[] PREFERENCE_KEYS_SECTION_0 = {KEY_COLOREDNAV, "selectcolorconfig"};
  private static final String[] PREFERENCE_KEYS_SECTION_1 = {
    ...
    if (userColorPreferences != null) {
      ...
      ColorAdapter adapter =
          new ColorAdapter(
              ...
              (selectedColor) -> {
                @ColorInt
                int primaryFirst = userColorPreferences.primaryFirstTab,
                ...
                activity
                    ...
                    .saveColorPreferences(
                        sharedPref,
                        new UserColorPreferences(primaryFirst, primarySecond, accent, iconSkin));
                if (dialog != null) dialog.dismiss();
  ...
  private void loadSection1() {
    ...
    selectedColors.setColorPreference(
        activity.getColorPreference(),
        activity.getCurrentColorPreference(),
    ...
    selectedColors.setListener(
        () -> {
          ...
          int colorPickerPref =
              sharedPref.getInt(
                  PreferencesConstants.PREFERENCE_COLOR_CONFIG, ColorPickerDialog.NO_DATA);
  ...
  private void checkCustomization() {
    boolean enableCustomization =
        sharedPref.getInt(PreferencesConstants.PREFERENCE_COLOR_CONFIG, ColorPickerDialog.NO_DATA)
  ...
  private void invalidateEverything() {
    ...
    if (currentSection == SECTION_1) {
      ColorPickerDialog selectedColors =
          (ColorPickerDialog) findPreference(KEY_PRESELECTED_CONFIGS);
