...
import com.droidtechlab.filemanager.asynchronous.services.AbstractProgressiveService;
...
/**
 * Created by Arpit on 01-08-2015 edited by Emmanuel Messulam <emmanuelbendavid@gmail.com>
 *
 * <p>Class stores the {@link AbstractProgressiveService} progress variables. This class also acts
 * as data carrier to communicate with {@link ProcessViewerFragment}
 */
public class DatapointParcelable implements Parcelable {
   ...
   */
  public DatapointParcelable(
      String name,
      int amountOfSourceFiles,
      int sourceProgress,
      long totalSize,
      long byteProgress,
      long speedRaw,
  ...
  /**
   * The same as {@link DatapointParcelable#DatapointParcelable(String, int, int, long, long, long,
   * boolean)} but allows move boolean to change the text from "Copying" to "Moving" in case of
   * copy.
   *
   * @param name name of source file being copied
   * @param amountOfSourceFiles total number of source files to be copied
  ...
  public static final Creator<DatapointParcelable> CREATOR =
      new Creator<DatapointParcelable>() {
        @Override
