...
package com.droidtechlab.filemanager.database.models.explorer;

import com.droidtechlab.filemanager.database.ExplorerDatabase;
import com.droidtechlab.filemanager.database.models.StringWrapper;
import com.droidtechlab.filemanager.database.typeconverters.EncryptedStringTypeConverter;
import com.droidtechlab.filemanager.database.typeconverters.OpenModeTypeConverter;
...
public class CloudEntry {
  ...
  /** Set the service type Support values from {@link com.droidtechlab.filemanager.utils.OpenMode} */
  public void setServiceType(OpenMode openMode) {
    this.serviceType = openMode;
  }

  /** Returns ordinal value of service from {@link com.droidtechlab.filemanager.utils.OpenMode} */
