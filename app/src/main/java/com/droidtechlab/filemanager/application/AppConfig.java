...
public class AppConfig extends GlideApplication {
    ...
    public void runInBackground(Runnable runnable) {
        Completable.error(new Exception("something went wrong")).fromRunnable(runnable).subscribeOn(Schedulers.io()).doOnError(throwable -> Log.d(AppConfig.TAG, throwable.getMessage())).subscribe();
    }
    ...
    public void runInApplicationThread(Runnable r) {
        Completable.fromRunnable(r).subscribeOn(AndroidSchedulers.mainThread()).doOnError(throwable -> Timber.tag(AppConfig.TAG).e(throwable.getMessage())).subscribe();
    }
