...
package com.droidtechlab.filemanager.asynchronous.asynctasks.ssh;

import static com.droidtechlab.filemanager.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT;
 ...
 *
 * <p>Used by {@link com.droidtechlab.filemanager.ui.dialogs.SftpConnectDialog}.
 *
 * @see SSHClient
 * @see SSHClient#authPassword(String, String)
 * @see SSHClient#authPublickey(String, KeyProvider...)
 * @see com.droidtechlab.filemanager.ui.dialogs.SftpConnectDialog#authenticateAndSaveSetup(String, String,
 *     int, String, String, String, String, KeyPair, boolean)
 * @see com.droidtechlab.filemanager.filesystem.ssh.SshConnectionPool#create(String)
 */
    ...
    if (result.exception != null) {
      if (SocketException.class.isAssignableFrom(result.exception.getClass())
        ...
        DisconnectReason disconnectReason =
            TransportException.class.cast(result.exception).getDisconnectReason();
        ...
        Toast.makeText(
                AppConfig.getInstance(), R.string.ssh_authentication_failure_key, Toast.LENGTH_LONG)
            .show();
      }
    }
  }
