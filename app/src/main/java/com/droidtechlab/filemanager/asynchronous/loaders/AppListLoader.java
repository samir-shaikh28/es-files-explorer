...
package com.droidtechlab.filemanager.asynchronous.loaders;
...
import com.droidtechlab.filemanager.asynchronous.broadcast_receivers.PackageReceiver;
import com.droidtechlab.filemanager.utils.InterestingConfigChange;
...
public class AppListLoader extends AsyncTaskLoader<AppListLoader.AppsDataPair> {
  ...
  public AppsDataPair loadInBackground() {
    ...
    for (ApplicationInfo object : apps) {
      if(object == null || object.sourceDir == null) continue;;
