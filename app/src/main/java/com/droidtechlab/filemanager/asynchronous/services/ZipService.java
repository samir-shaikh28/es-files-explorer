...
import com.droidtechlab.filemanager.filesystem.files.GenericCopyUtil;
import com.droidtechlab.filemanager.ui.activities.MainActivity;
import com.droidtechlab.filemanager.ui.notifications.NotificationConstants;
import com.droidtechlab.filemanager.utils.DatapointParcelable;
import com.droidtechlab.filemanager.utils.ObtainableServiceBinder;
import com.droidtechlab.filemanager.utils.ProgressHandler;
...
public class ZipService extends AbstractProgressiveService {
  ...
  public class CompressAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public CompressAsyncTask(
        ZipService zipService, ArrayList<HybridFileParcelable> baseFiles, String zipPath) {
    ...
    protected Void doInBackground(Void... p1) {
      ...
      zipService.addFirstDatapoint(
          baseFiles.get(0).getName(getApplicationContext()), baseFiles.size(), totalBytes, false);
    ...
    private void compressFile(File file, String path)
